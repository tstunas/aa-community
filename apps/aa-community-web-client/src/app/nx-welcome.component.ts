      ...
      <div class="container">
        ...
        <div id="welcome">
          <h1>
            ...
            Welcome aa-community-web-client 👋
          </h1>
        </div>
        <!--  HERO  -->
        ...
        <div id="middle-content">
          ...
          <div id="other-links">
            ...
            <div id="nx-cloud" class="rounded shadow">
              ...
              <a href="https://cloud.nx.app/connect/bLI8OC8D4E" target="_blank" rel="noreferrer">
...
nx run-many -t build test lint</pre>
          ...
          <details>
            ...
            <pre>nx show project aa-community-web-client</pre>
          </details>
